...
function MobileCompareContent() {
  ...
  const fetchResults = useCallback(async () => {
    ...
    try {
      ...
      if (filters.minData) queryParams.set("minData", filters.minData);
      if (filters.network) queryParams.set("network", filters.network);
              ...
              {loading ? (
                ...
                <>
                  <p className="mb-6 text-sm text-muted-foreground">
                    ...
                    {results.totalCount} mobile deals
                  </p>
                ...
                <div className="flex flex-col items-center justify-center rounded-xl border bg-background p-12 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-semibold">
                    No mobile deals found
                  </h3>
                  <p className="mb-6 max-w-md text-sm text-muted-foreground">
                    We couldn&apos;t find any mobile deals matching your
