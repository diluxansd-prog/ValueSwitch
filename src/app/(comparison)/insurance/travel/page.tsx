        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/80">Get covered for your holidays with affordable travel insurance</p>
            </div>
            {results && <div className="text-sm font-medium text-white/90">{results.totalCount} quotes found</div>}
          </div>
        </div>
      </section>
          ...
          <div className="flex items-center gap-3">
            <Sheet open={mobileFiltersOpen} onOpenChange={setMobileFiltersOpen}>
              ...
              <SheetContent side="left" className="w-80 overflow-y-auto">
                ...
                <div className="mt-6"><ComparisonFilters category="insurance" onFiltersChange={handleFiltersChange} providers={providers} /></div>
              </SheetContent>
            </Sheet>
              ...
              {loading ? (
                ...
                <>
                  <p className="mb-6 text-sm text-muted-foreground">
                    Showing {Math.min((page - 1) * ITEMS_PER_PAGE + 1, results.totalCount)}-{Math.min(page * ITEMS_PER_PAGE, results.totalCount)} of {results.totalCount} travel insurance quotes
                  </p>
                  <div className={viewMode === "grid" ? "grid grid-cols-1 gap-6 md:grid-cols-2" : "flex flex-col gap-4"}>
                ...
                <div className="flex flex-col items-center justify-center rounded-xl border bg-background p-12 text-center">
                  <Plane className="mb-4 size-12 text-muted-foreground/50" />
                  <h3 className="mb-2 text-lg font-semibold">No travel insurance quotes found</h3>
