...
function BroadbandCompareContent() {
  ...
  const fetchResults = useCallback(async () => {
    ...
    try {
      ...
      if (filters.minSpeed) queryParams.set("minSpeed", String(filters.minSpeed));
      if (filters.includesTV) queryParams.set("includesTV", "true");
      if (filters.contractLength) queryParams.set("contractLength", String(filters.contractLength));
              ...
              {loading ? (
                ...
                <>
                  <p className="mb-6 text-sm text-muted-foreground">
                    ...
                    {results.totalCount} broadband deals
                  </p>
                ...
                <div className="flex flex-col items-center justify-center rounded-xl border bg-background p-12 text-center">
                  <Wifi className="mb-4 size-12 text-muted-foreground/50" />
                  <h3 className="mb-2 text-lg font-semibold">
                    No broadband deals found
                  </h3>
                  <p className="mb-6 max-w-md text-sm text-muted-foreground">
                    We couldn&apos;t find any broadband deals matching your
...
export default function BroadbandComparePage() {
  return (
