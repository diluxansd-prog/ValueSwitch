        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/80">Find the best savings rates from leading UK banks</p>
            </div>
            {results && <div className="text-sm font-medium text-white/90">{results.totalCount} accounts found</div>}
          </div>
        </div>
      </section>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={sortBy} onValueChange={handleSortChange}>
                ...
                <SelectContent>
                  <SelectItem value="price">Interest Rate</SelectItem>
              ...
              {loading ? (
                ...
                <>
                  <p className="mb-6 text-sm text-muted-foreground">
                    Showing {Math.min((page - 1) * ITEMS_PER_PAGE + 1, results.totalCount)}-{Math.min(page * ITEMS_PER_PAGE, results.totalCount)} of {results.totalCount} savings accounts
                  </p>
                  <div className={viewMode === "grid" ? "grid grid-cols-1 gap-6 md:grid-cols-2" : "flex flex-col gap-4"}>
                ...
                <div className="flex flex-col items-center justify-center rounded-xl border bg-background p-12 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-semibold">No savings accounts found</h3>
