...
export const CURATED_OFFERS: CuratedOffer[] = [
  ...
  },
  {
    id: "scancom-ee-25",
    merchant: "scancom",
    merchantName: "Scancom",
    title: "25% off forever on EE rolling 30-day SIMs",
    description:
      "A lifetime 25% discount on EE rolling 30-day SIM plans — the discount applies every month, not just the first.",
    code: "SCANCOMVIP",
    endsAt: "2026-10-31",
    category: "sim",
    priority: 65,
  ...
  },
  {
    ...
    merchant: "scancom",
    merchantName: "Scancom",
    title: "20% off Three preloaded data SIMs",
    description:
      "20% off all Three preloaded data SIMs — great for dongles, tablets and backup connections.",
    code: "20%OFFTHREE",
    endsAt: "2027-01-06",
    category: "sim",
    priority: 60,
